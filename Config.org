...
#+end_src
* file--setup-roles.el
#+begin_src emacs-lisp :noweb yes :tangle setup-roles.el
(message "Installation of role--cozy-editor...")
(progn
  <<inst--cozy-editor>>
  )
(message "Installation of role--completion-navigation...")
(progn
  <<inst--completion-navigation>>
  )
(message "Installation of role--org...")
(progn
  <<inst--org>>
  )
(message "Installation of role--ide...")
(progn
  <<inst--ide>>
  )
(message "Installation of role--pretty-editor...")
(progn
  <<inst--pretty-editor>>
  )
(message "Installation of role--system")
(progn
  <<inst--system>>
  )
(message "Installation of role--games...")
(progn
  <<inst--games>>
  )
(message "Installation of themes...")
(progn
  <<inst--themes>>
  )
...
* =--Profiles------------------------------=
* profile--actual
#+begin_src emacs-lisp :noweb yes :tangle profiles/profile-actual.el
...
#+end_src
* profile--built-in
#+begin_src emacs-lisp :noweb yes :tangle profiles/profile-built-in.el
...
;;; Code:
;; <<package-manager--no-packages>>
<<role--built-in--core>>
<<role--built-in--site>>
<<role--built-in--experimental>>
(provide 'profile-built-in)
;;; profile-built-in.el ends here
#+end_src
* profile--craft
#+begin_src emacs-lisp :noweb yes :tangle profiles/profile-craft.el
...
#+end_src
* profile--devel
#+begin_src emacs-lisp :noweb yes :tangle profiles/profile-devel.el
...
#+end_src
* role--built-in--site
#+name: role--built-in--site
#+begin_src emacs-lisp :noweb yes
<<pckg--site--auto-complete>>
<<pckg--site--company-mode>>
<<pckg--site--dockerfile-mode>>
<<pckg--site--flycheck>>
<<pckg--site--magit>>
<<pckg--site--yaml-mode>>
<<pckg--site--rest>>
#+end_src
* role--built-in--experimental
#+name: role--built-in--experimental
#+begin_src emacs-lisp :noweb yes
<<pckg--rust-ruby-mode>>
<<pckg--rust-ts-mode>>
#+end_src
* role--completion-navigation
#+name: role--completion-navigation
#+begin_src emacs-lisp :noweb yes
;;; role--completion-navigation
<<pckg--cape>>
<<pckg--consult>>
...
<<pckg--vertico>>
#+end_src
#+name: inst--completion-navigation
...
<<pckg--hydra>>
<<pckg--emacs-cozy-set>>
<<pckg--emacs-file-formats-set>>
<<pckg--emacs-media-set>>
<<pckg--markdown-mode>>
<<pckg--yasnippet>>
#+end_src
#+name: inst--cozy-editor
#+begin_src emacs-lisp :results silent
...
(use-package flymake-clippy :ensure t)
(use-package tree-sitter :ensure t)
#+end_src
* role--games
#+name: role--games
...
#+end_src
* role--pretty-editor
#+name: role--pretty-editor
#+begin_src emacs-lisp :noweb yes
<<pckg--all-the-icons>>
<<pckg--fontaine>>
<<pckg--spacious-padding>>
#+end_src
#+name: inst--pretty-editor
#+begin_src emacs-lisp :results silent
(use-package fontaine :ensure t)
(use-package spacious-padding :ensure t)
(use-package all-the-icons
  ;; after first install need to execute 'M-x all-the-icons-install-fonts'
  :ensure t
  )
...
#+end_src
Example of auto tangle org files
#+begin_src emacs-lisp
(defvar cfg/u--org-babel-auto-tangle-list
  (list "semax.org"
        "heroes.org"))
(defun cfg/u--org-babel-tangle-config()
  (if
      (seq-contains cfg/u--org-babel-auto-tangle-list
                    (file-name-nondirectory(buffer-file-name)))
      (progn
        (message "Auto tangle org file")
 ...
 (add-hook 'org-mode-hook
           (lambda
             ()
             (add-hook 'after-save-hook #'cfg/u--org-babel-tangle-config)))
#+end_src
...
* =Built-in site=
* pckg--site--auto-complete
#+name: pckg--site--auto-complete
#+begin_src emacs-lisp :results silent
(use-feature-site auto-complete)
#+end_src
* pckg--site--color-theme
#+name: pckg--siter--color-theme
#+begin_src emacs-lisp :results silent
(use-feature-site color-theme)
#+end_src
* pckg--site--company-mode
#+name: pckg--site--company-mode
#+begin_src emacs-lisp :results silent
(use-feature-site company-mode
  ...
  #+end_src
* pckg--site--dockerfile-mode
#+name: pckg--site--dockerfile-mode
#+begin_src emacs-lisp :results silent
...
#+end_src
* pckg--site--flycheck
#+name: pckg--site-flycheck
#+begin_src emacs-lisp :results silent
(use-feature-site flycheck
  ;; :hook
  ;; (rust-ts-mode . flycheck-mode)
  )
#+end_src
* pckg--site--magit
#+name: pckg--site--magit
#+begin_src emacs-lisp :results silent
...
#+end_src
* pckg--site--yaml-mode
#+name: pckg--site--yaml-mode
#+begin_src emacs-lisp :results silent
(use-feature-site yaml-mode)
#+end_src
* =Repository=
* pckg--all-the-icons
#+name: pckg--all-the-icons
#+begin_src emacs-lisp :results silent
(use-package all-the-icons
...
#+end_src
* pckg--emacs-file-formats-set
#+name: pckg--emacs-file-formats-set
#+begin_src emacs-lisp
...
#+end_src
* bind--interactive-user-hotkeys
/The keys are bind when the *emacs* package included/ [[*pckg--emacs]]
#+name: bind--interactive-user-hotkeys
#+begin_src emacs-lisp
...
#+end_src
** bind--hydra-change-windows
#+name: bind--hydra-change-windows
#+begin_src emacs-lisp
...
(defun u--do-prepare-job-assist ()
  ...
  ;; (tab-bar-switch-to-next-tab)
  (tab-next)
  (u--toggle-tab-bar-headers-visible 0)
  (killless-mode t)
  )

(defun u--do-prepare-job-ide ()
  "Prepare Emacs for job IDE."
